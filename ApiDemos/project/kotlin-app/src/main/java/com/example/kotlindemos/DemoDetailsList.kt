...
class DemoDetailsList {
    companion object {
        val DEMOS = listOf(
            ...
            DemoDetails(
                R.string.circle_demo_label, R.string.circle_demo_description,
            ...
            DemoDetails(
                R.string.marker_close_info_window_on_retap_demo_label,
            ...
            DemoDetails(
                R.string.visible_region_demo_label,
